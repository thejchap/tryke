...
/// the filesystem incremental discovery path: collects tests, hooks,
/// guard-else lines, local import candidates, and the dynamic-import flag
/// in a single pass.
pub(crate) fn discover_file_from_body(
    root: &Path,
    src_roots: &[PathBuf],
    file: &Path,
    body: &[Stmt],
