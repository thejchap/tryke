...
Both plugins support [in-source tests](in-source-testing.md) unchanged — they consume tryke's
discovery output, which already carries guard-nested tests with correct file and line
information.
